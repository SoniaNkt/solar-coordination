$(function () {
  ...
  $('button#startButton').click(function () {
    ...
    $('#button-div').append('<img id="typing-gif" src="' + staticUrl + 'solar_coordination_classic/images/loading.gif" style="height:30px;">');
    ...
    $.ajax({
      ...
      success: function () {
        console.log('username:', username);
        // window.location.href = server_url + "/solar_coordination_classic";
        window.location.href = server_url + "/overview";
      },
